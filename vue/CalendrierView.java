...
//			      "July", "August", "September", "October", "November", "December" };
	    ...
	    lesMois = new String[] { "Janvier", "Février", "Mars", "Avril", "Mai", "Juin",
...
*/
	...
	//	bp.setLayout(new GridLayout(7, 7));
		...
		contentPanel.add(b0 = new JButton("L"));
		b0.setBackground(Color.GRAY);
		b0.setForeground(Color.BLACK);
		contentPanel.add(b0=new JButton("M"));
		b0.setBackground(Color.GRAY);
		b0.setForeground(Color.BLACK);
		contentPanel.add(b0=new JButton("M"));
		b0.setBackground(Color.GRAY);
		b0.setForeground(Color.BLACK);
		contentPanel.add(b0=new JButton("J"));
		b0.setBackground(Color.GRAY);
		b0.setForeground(Color.BLACK);
		contentPanel.add(b0=new JButton("V"));
		b0.setBackground(Color.GRAY);
		b0.setForeground(Color.BLACK);
		contentPanel.add(b0=new JButton("S"));
		b0.setBackground(Color.GRAY);
		b0.setForeground(Color.BLACK);
		contentPanel.add(b0 = new JButton("D"));
		b0.setBackground(Color.GRAY);
		b0.setForeground(Color.BLACK);
